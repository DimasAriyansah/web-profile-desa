				...
				<div class="footer-content">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<li><i class="fa fa"></i>JL.Raya Pegandekan</li>
							<li><i class="fa "></i>KEC.Kemangkon KAB.Purbalingga 53381<br></li>	
							<li><i class="fa fa-map-marker"></i>Kantor Karang Taruna</li>
							<li><i class="fa fa"></i>JL.Raya Pegandekan Dusun 3 Majingklak</li>
							<li><i class="fa "></i>KEC.Kemangkon KAB.Purbalingga 53381<br></li>						
						</ul>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<li><i class="fa fa-envelope-o pr-10"></i> Pegandekan@yahoo.com</li>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<img src="<?php echo base_url(); ?>assetku/img/pemedes.png" alt="">
							</div>
						</div>
					</div>
				</div>
...
<div class="footer-bawah">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				&copy; <span id="tahun"></span> All Rights Reserved By KKN Desa Pegandekan.
				<script>
