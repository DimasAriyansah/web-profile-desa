...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url();?>assetku/img/pegandekan.png" type="image/x-icon" />
	<meta charset="utf-8">
...
<body style="background-image:url(<?php echo base_url(); ?>images/pp.jpg);background-size:cover;">
            ...
            <div class="col-md-3 col-md-offset-4">
                <div class="login-panel panel ">
                    ...
                    <div class="panel-heading">
						<img src="<?php echo base_url(); ?>assetku/img/pegandekan.png" class="img-responsive"> 						
                    </div>
					...
					&copy; <span id="tahun"></span> All Rights Reserved By KKN UNPERBA.
					<script>
